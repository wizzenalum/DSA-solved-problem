/*############################################################################
	...
	You are given a Binary Search Tree containing positive integer values greater 
	than 0. You have to check whether this tree contains a dead-end or not. 
	The dead-end is a leaf node, after which we are not able to insert any node. 
	That is, a dead end is said to exist in a BST if there is a leaf node to which 
	a new child node cannot be added without violating the properties of a BST.
